...
1.到各大应用市场（豌豆荚、小米、魅族、三星等市场）或为知笔记官网[下载为知笔记  Android 版](http://misc.wiz.cn/download?product=wiznote&client=android-phone)
2.打开为知笔记，点击注册按钮
    ![A1](img/A1.jpg)
3.输入你的有效邮箱并设置一个密码，点击注册，就成为为知笔记的用户了
4.也可以通过第三方帐户登录，快速成为为知笔记的个人用户
    ![A2](img/A2.jpg)
    ![A3](img/A3.jpg)
