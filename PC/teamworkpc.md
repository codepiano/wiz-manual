...
####群组管理
**新建群组：**点击“+”新建群组，可在根据行业推荐的群组中选择，也可输入群组名称进行自定义![W14](W14.jpg)
...
在成员管理模块，可添加、删除团队成员，设置成员角色，将成员分配到群组等![W16](W16.jpg)
1. **添加成员**
...
####团队设置
在团队设置中，可修改团队名称、简介和电话![W17](W17.jpg)
...
+ **直接导入显示正文**：可以直接把文件拖拽到相应的目录下，文件会自动导入在正文显示。编辑的时候直接在编辑器中编辑，保存后笔记同步更新。目前支持office文档、PDF文档、TXT等多种格式文件。![W21](W21.jpg)

**3.创建笔记**

可以灵活的创建空白笔记，用于记录每日工作总结、会议记录、工作安排等。![W20](W20.jpg)
...
消息中心是用来接收标题@、评论、评论回复消息的统一入口![W23](W23.jpg)
